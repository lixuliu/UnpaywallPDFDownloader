...
Ваши пожертвования помогают поддерживать:

- 🌐 **Обслуживание веб-приложения** - Затраты на сервер, обновления и надежность
- 💻 **Разработка интерфейса локального приложения** - Новые функции и улучшения для настольной версии
- 🔧 Постоянная разработка и исправление ошибок для обеих платформ
- 📚 Поддержание документации в актуальном состоянии
- ⚡ Обеспечение совместимости с последними API

Даже небольшие взносы имеют большое значение для поддержания этого проекта живым и полезным для исследовательского сообщества!
