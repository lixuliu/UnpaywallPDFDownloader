...
A script to automatically download open-access research articles in PDF format using DOIs
from a CSV file. The script uses the Unpaywall API to check for open-access versions
...
Note: The CSV file should contain a column named 'DOI' with the Digital Object Identifiers. 
...
# Your email address for the Unpaywall API (replace with your email)
api_email = "your.email@example.com"

# Directory where you want to save the downloaded PDFs (replace with your desired path)
download_dir = "path/to/your/download/directory"
if not os.path.exists(download_dir):
    os.makedirs(download_dir)

# Path to your CSV file (replace with your CSV file path)
csv_file_path = "path/to/your/dois.csv"
